    ...
    <div class="container">
      ...
      <table class="table">
        ...
        <thead>
                ...
                <th><?php $tmp = $stats->factureMoy(); $nb_formated = number_format($tmp["value"], 2, ',', ' '); echo $nb_formated; ?> &euro;</th>
        </thead>
        <thead>
                <th>Total du chiffre d'affaire : </th>
                <th><?php $tmp = $stats->totalCA(); $nb_formated = number_format($tmp["ca"], 2, ',', ' '); echo $nb_formated; ?> &euro;</th>
        </thead>
      </table>
